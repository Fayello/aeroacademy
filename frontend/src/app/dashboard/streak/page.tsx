    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="angular-card bg-[#0f172a] p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">{t("streak.milestones")}</h2>
          ...
          {[7, 14, 21, 30, 60, 90, 180, 365].map((days) => {
            ...
            return (
              ...
              >
                ...
                {reached && (
                  <span className="inline-block mt-1 text-[9px] font-medium text-[#7AD62A] bg-[#7AD62A]/10 px-2 py-0.5 rounded-full">
                    {t("streak.reached")}
                  </span>
                )}
              </div>
