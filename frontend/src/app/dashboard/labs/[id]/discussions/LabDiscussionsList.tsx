...
export default function LabDiscussionsList() {
  ...
  const fetchPosts = useCallback(
    ...
    [labId, sortBy, debouncedSearch, selectedTag]
  );
  ...
  const handleCreatePost = async () => {
    ...
    setCreating(true);
    try {
      await fetchApi(`/discussions/lab/${labId}`, {
        method: "POST",
        body: JSON.stringify({
          title: newTitle.trim(),
          body: newBody.trim(),
        ...
        <>
          <div className="space-y-3">
            {posts.map((post) => (
              <Link
                key={post.id}
                href={`/dashboard/labs/${labId}/discussions/${post.id}`}
            ...
            <div className="p-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="What's your question about this lab?"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your question, share what you tried, or explain the issue..."
                  rows={6}
