    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          {/* Hero Header */}
          <div className="relative overflow-hidden angular-card bg-gradient-to-br from-[#0F203A] via-[#1a3a5c] to-[#229C62] p-6 sm:p-8 text-white">
                  ...
                  <div className="space-y-4">
                    {reviewsData.reviews.slice(0, 10).map((review) => (
                      <div key={review.id} className="angular-card border-slate-200 p-4">
                        ...
                        {review.comment && <p className="text-sm text-slate-600 ml-11">{review.comment}</p>}
                      </div>
                    ))}
                  </div>
                </>
            ...
            <div className="angular-card border-slate-200 p-5 text-center">
              <div className="relative inline-block mb-3">
                <svg width="80" height="80" viewBox="0 0 80 80" className="transform -rotate-90">
                  ...
                  <circle cx="40" cy="40" r="34" fill="none" stroke="#229C62" strokeWidth="6" strokeLinecap="round"
