...
import { GraduationCap, Microscope, Video, Calendar, Users, Loader2, ArrowRight, BarChart3, Activity, TrendingUp } from "lucide-react";
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
              ...
              <span className="text-sm font-medium">{stats?.totalStudents || 0} Active Students</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
              <TrendingUp size={16} className="text-emerald-400" />
              <span className="text-sm font-medium">{stats?.totalCourses || 0} Courses</span>
            </div>
          </div>
        </div>
      </div>
