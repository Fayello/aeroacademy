        ...
        <div className="mx-auto max-w-6xl space-y-8">
            ...
            <div className="grid gap-6 lg:grid-cols-[1.12fr_0.88fr]">
              <div>
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Link href="/community/ambassador-program" className="inline-flex items-center justify-center rounded-xl border border-white/10 px-5 py-3 text-sm font-medium text-slate-200 transition-colors hover:bg-white/5">
                    Compare ambassador path
                  </Link>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-[#7AD62A]/20 bg-[#0b1627]/80 p-5">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3">
                  {[
                    { icon: HandHeart, label: "Mentoring energy" },
                    { icon: Users, label: "Learner support" },
                    { icon: School2, label: "Event continuity" },
                  ].map((item) => (
          ...
          <section className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-[#0f172a] p-6 lg:col-span-2">
              <h2 className="text-2xl font-bold text-white">What volunteers do</h2>
          ...
          <section className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-[#7AD62A]/20 bg-gradient-to-br from-[#0F203A] to-[#122a47] p-6">
              ...
              <h2 className="mt-3 text-2xl font-bold text-white">How the volunteer path works</h2>
              <div className="mt-5 space-y-3">
